...
const DEFAULT_SETTINGS: TrainingModuleSettings = {
  clientName: "",
  sessionNote: "",
  practiceText: "말하기 전에 숨을 한 번 고르고 천천히 이어서 말해 볼게요.",
...
function getStatusStyle(statusText: string): React.CSSProperties {
  if (statusText === "훈련 진행 중") {
    return { background: "#eaf8ee", color: "#2e7d4a", border: "1px solid #b8dfc2" };
  }
  if (statusText === "훈련 완료") {
    return { background: "#e7f7ea", color: "#2e7d32", border: "1px solid #b8debd" };
  }
...
export default function MixedTrainer() {
  ...
  function syncForClient(nextName: string, nextNote: string) {
    ...
    const saved = loadTrainingSettings("mixed", DEFAULT_SETTINGS, normalizedName);
  ...
  function resetSettingsToDefault() {
    ...
    clearTrainingSettings("mixed", clientName);
    ...
    <div style={{ display: "grid", gap: 20 }}>
      <section style={{ border: "1px solid #ddd", borderRadius: 12, padding: 16, background: "#fff" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          <h1 style={{ margin: 0, fontSize: 24, color: "#2e7d4a" }}>시각 + 청각 혼합 훈련</h1>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <Link href="/results" style={{ padding: "10px 14px", borderRadius: 10, border: "1px solid #b8dfc2", background: "#f5fcf7", color: "#2e7d4a", textDecoration: "none", fontWeight: 600 }}>
              결과 보기
            </Link>
          </div>
        </div>
          ...
          <div style={{ display: "grid", gap: 10, marginBottom: 16 }}>
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
              ...
              <button
                ...
                disabled={isRunning}
                style={{ padding: "8px 12px", borderRadius: 8, border: "1px solid #cfe4d5", background: "#f7fcf8", cursor: isRunning ? "not-allowed" : "pointer" }}
              >
                이 사용자의 설정 초기화
              </button>
            </div>
              ...
              {presets.map((preset) => (
                <button
                  ...
                  style={{
                    padding: "8px 12px",
                    borderRadius: 999,
                    border: selectedPresetId === preset.id ? "1px solid #91d0a5" : "1px solid #cfe4d5",
                    background: selectedPresetId === preset.id ? "#e6f7e6" : "#f5fcf7",
                    color: "#2e7d4a",
          ...
          <div style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 16, background: "#fafafa", marginBottom: 16 }}>
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                ...
                <button type="button" onClick={handleSavePreset} style={{ padding: "10px 14px", borderRadius: 10, border: "none", background: "#16a34a", color: "#fff", cursor: "pointer", fontWeight: 700 }}>
                  preset 저장
                </button>
        ...
        <section style={{ border: "1px solid #ddd", borderRadius: 12, padding: 20, background: "#fff" }}>
          ...
          <div style={{ display: "grid", gap: 12, fontSize: 15 }}>
            ...
            <div style={{ color: "#666", fontSize: 14 }}>
              혼합 훈련은 시각 페이싱 바와 구 시작 청각 cue를 함께 사용합니다.
            </div>
          </div>
        </section>
      </div>
      ...
      <section style={{ border: "1px solid #ddd", borderRadius: 12, padding: 20, background: "#fff" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12, flexWrap: "wrap", marginBottom: 16 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            <button onClick={decreaseFontSize} type="button" style={{ padding: "6px 10px", borderRadius: 8, border: "1px solid #b8dfc2", background: "#f5fcf7", cursor: "pointer", fontWeight: 700 }}>
              A-
            </button>
            <button onClick={increaseFontSize} type="button" style={{ padding: "6px 10px", borderRadius: 8, border: "1px solid #b8dfc2", background: "#f5fcf7", cursor: "pointer", fontWeight: 700 }}>
              A+
            </button>
          </div>
        </div>
          ...
          {chunks.map((chunk, index) => (
            <span
              ...
              style={{
                ...
                background: index === activeChunkIndex ? "#e6f7e6" : "transparent",
        ...
        <div style={{ position: "relative", height: 52, borderRadius: 999, background: "#eef7f0", border: "1px solid #cfe4d5", marginBottom: 18, overflow: "hidden" }}>
          <div
            style={{
              position: "absolute",
        ...
        {recordedAudioUrl && (
          <div style={{ marginTop: 18, padding: 14, borderRadius: 12, background: "#f5fcf7", border: "1px solid #d6eddc" }}>
            <strong style={{ color: "#2e7d4a" }}>녹음 다시 듣기</strong>
