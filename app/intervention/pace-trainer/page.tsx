...
export default function PaceTrainerPage() {
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <p className="mt-3 text-slate-600">
            시각·청각·혼합 단서를 이용한 말속도 조절 훈련입니다. 파킨슨병·
            구썍·조음장애 등 조절이 어려운 대상자에게 말속도 인식과 자기
            조절을 연습하는 쪽으로 설계되었습니다.
          </p>
        </section>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          <div className="mb-6">
            ...
            <p className="mt-2 text-sm text-slate-500">
              먼저 대상자 정보와 세션 메모를 저장한 뒤 각 훈련으로 이동합니다.
            </p>
          </div>
        ...
        <section className="rounded-2xl bg-white p-8 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-500">
            아래 버튼을 누르면 현재 입력한 대상자 정보가 저장된 뒤 해당 훈련
            화면으로 이동합니다.
          </p>
