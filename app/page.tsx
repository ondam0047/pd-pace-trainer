...
const MODULES: Module[] = [
  ...
  { href: "/articulator-3d", title: "조음기관 3D", subtitle: "Articulator 3D · 비교·훈련·음소산출", description: "조음기관 3D 하나에 목표↔실제 비교 · 음운변동 대립쌍 훈련 · 자음/모음 음소산출을 탭으로 통합", color: "emerald", status: "ready" },
